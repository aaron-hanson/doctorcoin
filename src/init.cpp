...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 4023 or testnet: 14023)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 4022 or testnet: 14022)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Doctorcoin Wiki for SSL setup instructions)") + "\n" +
