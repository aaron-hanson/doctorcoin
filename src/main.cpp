...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x983d61d7f197a84c35cf2126d24a6d3c734c75dc8598e613cbf79e9dc77b634b"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Doctorcoin: increase each by adding 2 to bitcoin's value.
